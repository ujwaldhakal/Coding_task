...
class Survey extends Model
{
     ...
     * $fillable
     */
    protected $fillable = ['name' => 'Name','gender' => 'Gender','phone' => 'Phone','address' => 'Address','email' => 'Address','nationality' => 'Nationality','dob' => 'Date of birth','education' => 'Education background','contact_mode'=>'Preferred mode of contact'];
